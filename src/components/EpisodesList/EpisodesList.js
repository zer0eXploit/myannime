...
class EpisodesList extends Component {
  ...
  //             to={"/Anime/" + this.props.animeId + "/" + this.props.animeId}
  //           >
  ...
  render() {
    ...
    if (this.props.episodes.length > 0) {
      episodesList = this.props.episodes.map((episode) => {
        return (
          <ListItem
            button
            key={episode.episode_id}
            component={RouterLink}
            to={"/Anime/" + this.props.animeId + "/" + episode.episode_id}
          >
            <ListItemText primary={"Episode " + episode.episode_number} />
          </ListItem>
        );
      });
    }
